            ...
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-4 ">
                    <div>
                        ...
                        <p className="text-lg text-opacity-75 tracking-wide leading-relaxed text-gray-900">SMP
                        ...
                        <p className="pt-4 text-lg text-opacity-75 tracking-wide leading-relaxed text-gray-900">SMP
                    ...
                    <div>
                        <img className="w-50" src="https://zamzamsyifa.sch.id/wp-content/uploads/2019/08/FASIII-1.jpg"></img>
                    </div>
                </div>
            </div>
        </div>
